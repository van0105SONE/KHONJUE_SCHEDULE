        ...
        public void Compose(IDocumentContainer container)
        {
            container.Page(page =>
            {
                ...
                page.Content().Table(table =>
                {
                    ...
                    table.Header(header =>
                    {
                        header.Cell().Element(CellStyle).AlignCenter().Text("ລະຫັດພາກຮຽນ").Bold();
                        header.Cell().Element(CellStyle).AlignCenter().Text("ຊືພາກຮຽນ").Bold();
