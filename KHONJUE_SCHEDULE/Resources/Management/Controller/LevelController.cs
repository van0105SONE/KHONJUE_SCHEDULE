...
namespace KHONJUE_SCHEDULE.Resources.Management.Controller
{
    public class LevelController
    {
        ...
        public bool CreateLevel(string levelName)
        {
            try
            {
                _command = new NpgsqlCommand();
                _command.Connection = _databaseContext.dbConnection;
                _command.CommandText = $@"INSERT INTO study_level (""LevelCode"", ""LevelName"") VALUES ('KJ{DateTime.Now.Ticks}', '{levelName}')";
                _command.ExecuteNonQuery();
                return true;
            }
            catch (Exception ex)
        ...
        public List<LevelModel> getLevels()
        {
            try
            {
                ...
                _command = new NpgsqlCommand();
                _command.Connection = _databaseContext.dbConnection;
                _command.CommandText = "SELECT * FROM study_level";
